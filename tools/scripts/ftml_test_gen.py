...
#       Keep in mind that characters with varying finals (yeh, noon, qaf) need two codes.
...
def expand_sequences(mode, basicSequences) :
    ...
    if mode == "basicforms" :
        ...
        expand = {
            ...
            "beh"       :   ["dotlessBeh", "beh2below1above", "teh3down", "tehRing", "beeh", "tteheh", "peh", "tteh", "theh", "teh"],
            "jeem"      :   ["hah2vert", "hah4below", "hahTah2smd", "hahTah", "hah3dots", "hahHamza", "tcheheh",  "dyeh", "tcheh", "khah", "hah"],
            ...
            "noon"      :   ["noon3dots", "noonSmallV", "noonRingAbove", "noonRing", "rnoon", "noonDotBelow", "noonRetro", "noonGhunna"],
        ...
        expandLeft = {  # initial/medial forms of letters that have different finals
            "beh"       :   ["noon3dotsIM", "noonSmallVIM", "noonRingAboveIM", "noonRingIM", "rnoonIM", "noonDotBelowIM", "noonRetroIM", "noonGhunnaIM", "noonIM",
                                "alefMaksuraIM", "arabicEIM", "yehSmallVIM", "yehHamzaIM", "chotiyehIM"],
            "feh"       :   ["dotlessQafIM", "qaf3dotsIM", "qafIM"]
        }
...
def _group_name_format(charName) :
    ...
    groupNameFormat = {
        ...
        "beh2below1above"   :   ('02i',     'Beh with two dots below and one above',2, 2),
        ...
        "noonRingAboveIM"   :   ('02x6',    'Noon-ring-above initial/medial form',  0, 2),
        "noonSmallVIM"      :   ('02x7',    'Noon-small-V initial/medial form',     0, 2),
        "noon3dotsIM"       :   ('02x8',    'Noon-with-3-dots initial/medial forms',0, 2),
        ...
        "hah2vert"      :   ('03k',     "Hah with 2 dots vertically above", 2, 2),
        ...
        "qaf3dotsIM"    :   ('10d',     'Qaf with three dots',              0, 2),
        "dotlessFeh"    :   ('10e',     'Dotless feh',                      2, 2),
        "dotlessQafIM"  :   ('10f',     'Dotless qaf initial/medial form',	0, 2),
        "qaf"           :   ('11',      'Qaf form',         		2, 0),
        "qaf3dots"      :   ('11a',     'Qaf with three dots',      2, 0),
        ...
        "noonRing"      :   ('15e',     "Noon-ring form",       2, 0),
        "noonRingAbove" :   ('15f',     "Noon-ring-above form", 2, 0),
        "noonSmallV"    :   ('15g',     "Noon-small-V form",    2, 0),
        "noon3dots"     :   ('15h',     "Noon with three dots", 2, 0),
