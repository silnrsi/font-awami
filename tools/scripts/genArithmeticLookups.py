...
# THIS SCRIPT NO LONGER GENERATES THE EXPECTED OUTPUT. CLEAN IT UP!
...
kwMinClass = -2400   # We don't need to do arithmetic with all these; the lower ones are only used for bariyeh tails
kwMin = 1600
kwMax = 1600
...
def GenClass(prefix, cname, minv, maxv):
...
print("\n# Classes\n", file=fout)
GenClass('dx', "DxMarker", dxMin, dxMax)
GenClass('dy', "DyMarker", dyMin, dyMax)
GenClass('kw', "KwMarker", kwMinClass, kwMax)
GenClass("px", "PxMarker", pxMin, pxMax)
GenClass("pxf", "PxfMarker", pxfMin, pxfMax)
GenClass("py", "PyMarker", pyMin, pyMax)
GenClass("asc", "AscMarker", ascMin, ascMax)
GenClass("dsc", "DscMarker", dscMin, dscMax)
GenClass("yt", "YtMarker", ytMin, ytMax)
GenClass("yb", "YbMarker", ybMin, ybMax)
GenClass("ytk", "YtkMarker", ytMin, ytMax)
GenClass("ybk", "YbkMarker", ybMin, ybMax)
