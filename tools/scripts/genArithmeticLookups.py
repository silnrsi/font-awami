...
def GenLookups_MarkerYtb2AscDsc():
...
# end of GenLookups_MarkerYtb2AscDsc
...
# Top-level lookups defined outside of the feature

outfile = "../../source/opentype/arithTopLookups.feax"
fout = open(outfile, 'w');
print("# This file was generated by the genArithmeticLookups.py script.", file=fout)
print("# It contains top-level lookups that are defined outside of the calt feature\n# due to being auto-generated.", file=fout)

print("\n# Marker Manipulation\n", file=fout)
GenLookups_MarkerYtb2AscDsc();
