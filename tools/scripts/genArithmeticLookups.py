...
fout = open(outfile, 'w');
print("# This file was generated by the genArithmeticLookups.py script.", file=fout)
print("# These are top-level lookups that must go in a specific place relative to the other lookups.", file=fout)

print("\n# Marker manipulation\n", file=fout)
GenLookups_MarkersYtb2AscDsc();

# These lookups are flattened them for the sake of performance.
